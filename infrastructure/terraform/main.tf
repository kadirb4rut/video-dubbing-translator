...
resource "aws_ecs_task_definition" "worker" {
  ...
  container_definitions = jsonencode([{
    ...
    environment = [
      ...
      { name = "TRANSLATION_REFINEMENT_PROVIDER", value = var.translation_refinement_provider },
      { name = "TRANSLATION_REFINEMENT_MAX_PASSES", value = tostring(var.translation_refinement_max_passes) },
