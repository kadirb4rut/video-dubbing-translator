...
def macbook_Speaker(sentences, path_wav, source_language, target_language, speaker_wav_dir): #  8 gender
    ...
    from backend.app.providers_real import VoxCPM2VoiceProvider
...
#             # Get device
#             device = "cuda" if torch.cuda.is_available() else "cpu"
#             # Legacy TTS path removed; use VoxCPM2VoiceProvider.
# 
...
def parse_args():
    ...
    parser.add_argument(
        "--speaker-wav-dir",
        help="VoxCPM2 icin 1.wav, 2.wav seklinde konusmaci referans seslerinin bulundugu klasor. Verilmezse vokal parcalarindan uretilir.",
    )
