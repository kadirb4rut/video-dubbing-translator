...
Compare the original input video with the translated output generated by the app.

<table>
  <tr>
    <td align="center"><strong>Input Video</strong></td>
    <td align="center"><strong>Translated Output</strong></td>
  </tr>
  <tr>
    <td>
      <video controls width="100%" src="https://github.com/kadirb4rut/video-dubbing-translator/releases/download/demo-videos/input.mp4"></video>
    </td>
    <td>
      <video controls width="100%" src="https://github.com/kadirb4rut/video-dubbing-translator/releases/download/demo-videos/target.mp4"></video>
    </td>
  </tr>
</table>

Both videos are stored as GitHub release assets, not local README links, so visitors can press play directly from the repository page.
